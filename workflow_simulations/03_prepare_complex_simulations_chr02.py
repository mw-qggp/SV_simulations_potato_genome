...
def rmt_format(dict_svs,svtype,max_mutations,dict_svtype_before):
	...
	outfile1 = open("haplotype1_chr02.rmt", 'a')
	outfile2 = open("haplotype2_chr02.rmt", 'a')
	outfile3 = open("haplotype3_chr02.rmt", 'a')
	outfile4 = open("haplotype4_chr02.rmt", 'a')
...
#deletions
dict_dummy = {}
dict_svs = random_position(80,80,40,10,2,100,312,dict_dummy)
dict_deletions = rmt_format(dict_svs,"de",312,dict_dummy)

#insertions
dict_insertions = random_position(80,80,40,10,2,100,624,dict_deletions)
dict_deletions_insertions = rmt_format(dict_insertions,"in",312,dict_deletions)

#inversions
dict_inversions = random_position(30,8,8,4,4,0,678,dict_deletions_insertions)
dict_deletions_insertions_inversions = rmt_format(dict_inversions,"iv",54,dict_deletions_insertions)

#duplications
dict_duplications = random_position(30,8,12,10,2,0,740,dict_deletions_insertions_inversions)
...
#SNPs
random_SNPs(dict_deletions_insertions_inversions_duplications,"sn",30000)
